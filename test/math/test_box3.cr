...
class TestBox3 < Minitest::Test
  ...
  def test_constructor
    ...
    a = Tres::Box3.new(zero3.clone, zero3.clone)
    assert_equal(zero3, a.min)
    assert_equal(zero3, a.max)

    a = Tres::Box3.new(zero3.clone, one3.clone)
    assert_equal(zero3, a.min)
  ...
  def test_set_from_points
    ...
    a.set_from_points([] of Tres::Vector3)
    assert(a.empty?)
  end
  ...
  def test_contains_box
    a = Tres::Box3.new(zero3.clone, zero3.clone)
    b = Tres::Box3.new(zero3.clone, one3.clone)
    c = Tres::Box3.new(one3.clone.negate, one3.clone)
  ...
  def test_get_parameter
    a = Tres::Box3.new(zero3.clone, one3.clone)
    b = Tres::Box3.new(one3.clone.negate, one3.clone)

    assert_equal(Tres::Vector3.new(0, 0, 0), a.parameter(Tres::Vector3.new(0, 0, 0)))
    assert_equal(Tres::Vector3.new(1, 1, 1), a.parameter(Tres::Vector3.new(1, 1, 1)))

    assert_equal(Tres::Vector3.new(0, 0, 0), b.parameter(Tres::Vector3.new(-1, -1, -1)))
    assert_equal(Tres::Vector3.new(0.5, 0.5, 0.5), b.parameter(Tres::Vector3.new(0, 0, 0)))
    assert_equal(Tres::Vector3.new(1, 1, 1), b.parameter(Tres::Vector3.new(1, 1, 1)))
  end
  ...
  def test_clamp_point
    ...
    assert_equal(Tres::Vector3.new(0, 0, 0), a.clamp_point(Tres::Vector3.new(0, 0, 0)))
    assert_equal(Tres::Vector3.new(0, 0, 0), a.clamp_point(Tres::Vector3.new(1, 1, 1)))
    assert_equal(Tres::Vector3.new(0, 0, 0), a.clamp_point(Tres::Vector3.new(-1, -1, -1)))

    assert_equal(Tres::Vector3.new(1, 1, 1), b.clamp_point(Tres::Vector3.new(2, 2, 2)))
    assert_equal(Tres::Vector3.new(1, 1, 1), b.clamp_point(Tres::Vector3.new(1, 1, 1)))
    assert_equal(Tres::Vector3.new(0, 0, 0), b.clamp_point(Tres::Vector3.new(0, 0, 0)))
    assert_equal(Tres::Vector3.new(-1, -1, -1), b.clamp_point(Tres::Vector3.new(-1, -1, -1)))
    assert_equal(Tres::Vector3.new(-1, -1, -1), b.clamp_point(Tres::Vector3.new(-2, -2, -2)))
  end
  ...
  def test_distance_to_point
    ...
    assert_equal(0, a.distance_to_point(Tres::Vector3.new(0, 0, 0)))
    assert_in_delta(Math.sqrt(3), a.distance_to_point(Tres::Vector3.new(1, 1, 1)))
    assert_in_delta(Math.sqrt(3), a.distance_to_point(Tres::Vector3.new(-1, -1, -1)))

    assert_in_delta(Math.sqrt(3), b.distance_to_point(Tres::Vector3.new(2, 2, 2)))
    assert_equal(0, b.distance_to_point(Tres::Vector3.new(1, 1, 1)))
    assert_equal(0, b.distance_to_point(Tres::Vector3.new(0, 0, 0)))
    assert_equal(0, b.distance_to_point(Tres::Vector3.new(-1, -1, -1)))
    assert_in_delta(Math.sqrt(3), b.distance_to_point(Tres::Vector3.new(-2, -2, -2)))
  end
  ...
  def test_is_intersection_box
    ...
    b.translate(Tres::Vector3.new(2, 2, 2))
  ...
  def test_get_bounding_sphere
    ...
    assert_equal(Tres::Sphere.new(zero3, 0), a.bounding_sphere)
    assert_equal(Tres::Sphere.new(one3.clone.multiply_scalar(0.5), Math.sqrt(3) * 0.5), b.bounding_sphere)
    assert_equal(Tres::Sphere.new(zero3, Math.sqrt(12) * 0.5), c.bounding_sphere)
  end
  ...
  def test_apply_matrix4
    ...
    b = Tres::Box3.new(zero3.clone, one3.clone)
    c = Tres::Box3.new(one3.clone.negate, one3.clone)
    d = Tres::Box3.new(one3.clone.negate, zero3.clone)

    m = Tres::Matrix4.new.make_translation(1, -2, 1)
    t1 = Tres::Vector3.new(1, -2, 1)
  ...
  def test_translate
    ...
    assert_equal(Tres::Box3.new(one3, one3), a.clone.translate(one3))
