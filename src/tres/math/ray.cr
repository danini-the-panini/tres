module Tres
  class Ray
    ...
    def initialize(origin = Tres::Vector3.new, direction = Tres::Vector3.new)
    ...
    def closest_point_to_point(point, target = Tres::Vector3.new)
    ...
    def distance_sq_to_segment(v0, v1, point_on_ray = nil, point_on_segment = nil)
      seg_center = Tres::Vector3.new
      seg_dir = Tres::Vector3.new
      diff = Tres::Vector3.new
    ...
    def intersect_sphere(sphere, target = Tres::Vector3.new)
    ...
    def intersect_plane(plane, target = Tres::Vector3.new)
    ...
    def intersect_box(box, target = Tres::Vector3.new)
    ...
    def intersect_triangle(a, b, c, backface_culling, target = Tres::Vector3.new)
      # Compute the offset origin, edges, and normal.
      diff = Tres::Vector3.new
      edge1 = Tres::Vector3.new
      edge2 = Tres::Vector3.new
      normal = Tres::Vector3.new
